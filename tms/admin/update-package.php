...
<html>
<head>
<title>VM | Admin Package Creation</title>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price in Per Day Rs.</label>
									<div class="col-sm-8">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="packagedetails" id="packagedetails" placeholder="Place Details" required><?php echo htmlentities($result->PackageDetails);?></textarea> 
									</div>
								</div>															
<div class="form-group">
